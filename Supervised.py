...
#from sklearn.utils.testing import all_estimators #CREATES AN ERROR
...
#Next lines modified by adding "sklearn.utils."
CLASSIFIERS = [est for est in sklearn.utils.all_estimators(
) if issubclass(est[1], ClassifierMixin)]
REGRESSORS = [est for est in sklearn.utils.all_estimators(
) if issubclass(est[1], RegressorMixin)]

#removed some defunct terms here
